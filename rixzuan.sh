...
echo 'echo -e "#          Whatsapp - +6016-9441625          #"' >> .bashrc
echo 'echo -e "#                                            #"' >> .bashrc
echo 'echo -e "#            Script By RixzuanSSH            #"' >> .bashrc
echo 'echo -e "#                                            #"' >> .bashrc
echo 'echo -e "#                                            #"' >> .bashrc
echo 'echo -e "##############################################"' >> .bashrc
echo 'echo -e ""' >> .bashrc
...
echo "UserOVPN     (Membuat Akaun OVPN)"  | tee -a log-install.txt
...
echo "#          Whatsapp - +6016-9441625          #"  | tee -a log-install.txt
echo "#                                            #"  | tee -a log-install.txt
echo "#            Script By RixzuanSSH            #"  | tee -a log-install.txt
echo "#                                            #"  | tee -a log-install.txt
echo "#                                            #"  | tee -a log-install.txt
echo "##############################################"  | tee -a log-install.txt
echo ""  | tee -a log-install.txt
