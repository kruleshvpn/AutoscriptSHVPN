...
cd
wget https://github.com/kruleshvpn/AutoscriptSHVPN/raw/master/screenFetch/archive/master.zip
...
echo "<pre>Setup by Khairul Amin | 01119800265</pre>" > /home/vps/public_html/index.html
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/kruleshvpn/AutoscriptSHVPN/master/client-1194.conf"
sed -i $MYIP2 /etc/openvpn/1194-client.ovpn;
PASS=`cat /dev/urandom | tr -dc 'a-zA-Z0-9' | fold -w 15 | head -n 1`;
useradd -M -s /bin/false krule
echo "krule:$PASS" | chpasswd
...
# info
clear
echo "Krule SHVPN | 01119800265" | tee log-install.txt
