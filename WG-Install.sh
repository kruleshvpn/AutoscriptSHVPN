...
function installQuestions() {
	...
	echo "==================================================="
	echo ""
	echo "Welcome to the WireGuard installer! by Khairul SHVPN"
	echo "Any enquiries you can directly contact me : Khairul SHVPN (01119800265)"
	echo ""
	...
	until [[ ${SERVER_WG_IPV4} =~ ^([0-9]{1,3}\.){3} ]]; do
		read -rp "Server's WireGuard IPv4: " -e -i 20.55.55.1 SERVER_WG_IPV4
	done
...
ENDPOINTED="${BUG_REG}:${SERVER_PORT}"
	# Create client file and add the server as a peer
	echo "[Interface]
PrivateKey = ${CLIENT_PRIV_KEY}
Address = ${CLIENT_WG_IPV4}/16
...
AllowedIPs = ${CLIENT_WG_IPV4}/16" >>"/etc/wireguard/${SERVER_WG_NIC}.conf"
...
function manageMenu() {
	...
	echo "==================================================="
	echo ""
	echo "Welcome to WireGuard-install! by Khairul SHVPN"
	echo "Any enquiries you can contact me directly - Khairul SHVPN (01119800265)"
	echo ""
